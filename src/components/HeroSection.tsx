    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-1/4 -right-1/4 w-[600px] h-[600px] rounded-full bg-primary/20 blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          >
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="p-3 rounded-full bg-primary-foreground/10 text-primary-foreground hover:bg-primary hover:text-primary-foreground transition-colors"
                aria-label={label}
              >
                <Icon size={20} />
              </motion.a>
